...
comdex tx gov submit-proposal add-lend-pool cmdx 3 1 1,2,3 1,0,1 --from cooluser --chain-id test-1 --keyring-backend test --title "nothing" --description "not" --deposit 100000000stake -y
comdex q lend pools
